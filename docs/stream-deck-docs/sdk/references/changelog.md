...
## Stream Deck
### v7.1.0
  * Added support for [embedding resources](/sdk/guides/resources.md) within actions.
  * Added support for Node.js 24, configurable within the [manifest](/sdk/references/manifest.md#nodejs-version).
...
### v7.0.0
  * Added `streamDeck.devices.onDeviceDidChange` event.
    ...
    * [Learn more](/sdk/guides/devices.md#changing) about listening to device changes.
  * Added support for passive deep-link messages using the `?streamdeck=hidden` query parameter.
    ...
    * [Learn more](/sdk/guides/deep-linking.md#active-vs-passive) about active vs passive deep-link message.
...
### v6.9.0
  * Added `SupportURL` option to the manifest:
    ...
    * Specifying a `SupportURL` at the [root level](/sdk/references/manifest.md#manifest-supporturl) (plugin) will apply to all actions.
    * Specifying a `SupportURL` at the [action level](/sdk/references/manifest.md#action-supporturl) will override the plugin `SupportURL`.
