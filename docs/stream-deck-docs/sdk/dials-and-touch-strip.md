...
tags: [sdk, dials, touch-strip, encoder]
timestamp: 2026-07-11T20:01:18.305033+09:00
---
...
## Layouts
Layouts are used to draw information about your actions on the touch display. Stream deck has a few [built-in layouts](dials-and-touch-strip.md#built-in-layouts), but you can also build your own [custom layouts](dials-and-touch-strip.md#custom-layouts) using JSON files included in your plugin folder. Layouts are composed of [layout items](touch-strip-layout.md#definitions) that can be updated programmatically.
### Built-in Layouts
...
#### Programmatically
Built-in layouts can also be assigned to an instance of an action programmatically using the [`setFeedbackLayout`](dials-and-touch-strip.md#setfeedbacklayout) function, for example:
...
### Custom Layouts
Custom layouts are composed of [layout items](touch-strip-layout.md) provided in a JSON file located in the `*.sdPlugin` folder.
warning
...
#### Programmatically
Custom layouts can also be assigned to an instance of an action programmatically using the [`setFeedbackLayout`](dials-and-touch-strip.md#setfeedbacklayout) function, for example:
...
#### Debugging
You can debug your custom layouts using the CLI tool's [`validate`](../cli/streamdeck-validate.md) command.
Terminal
...
## Updating Layouts
You can update the values in a layout programmatically using the [`setFeedback`](dials-and-touch-strip.md#setfeedback) function, by referencing layout items by their `key`. You can directly update the value of the item or set specific properties of the item. Properties not included in the payload will remain unchanged.
...
You can programmatically update the trigger descriptions using the [`setTriggerDescription`](dials-and-touch-strip.md#settriggerdescription) function.
