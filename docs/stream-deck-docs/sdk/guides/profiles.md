...
type: Guide
title: "Profiles"
description: "Stream Deck Profiles are shareable layouts, specific to a Stream Deck device, that can include pre-defined actions, icons, and settings."
resource: "https://docs.elgato.com/streamdeck/sdk/guides/profiles"
tags: ['streamdeck', 'sdk', 'profiles']
