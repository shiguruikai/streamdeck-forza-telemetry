...
description: "The Stream Deck SDK can notify your plugin when an application starts (launches) or stops (terminates), allowing it to monitor pre-registered apps."
resource: "https://docs.elgato.com/streamdeck/sdk/guides/app-monitoring"
tags: ['streamdeck', 'sdk', 'app-monitoring']
