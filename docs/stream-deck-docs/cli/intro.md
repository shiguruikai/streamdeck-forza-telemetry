...
type: Guide
title: "Introduction"
description: "Stream Deck CLI is a command-line interface tool for building, managing, and packaging Stream Deck plugins, and is the quickest way to get up-and-runn"
...
## What's next?
  * Create your first Stream Deck plugin using the [`streamdeck create`](/cli/commands/create.md) command.
