...
type: Guide
title: "System"
description: "The Stream Deck SDK provides utilities to streamline interacting with common system functionality, such as monitoring an app launching or terminating and rec..."
resource: https://docs.elgato.com/streamdeck/sdk/guides/system/
tags: [sdk, system, events]
timestamp: 2026-07-11T20:01:18.314954+09:00
---

# System
The Stream Deck SDK provides utilities to streamline interacting with common system functionality, such as [monitoring an app launching or terminating](app-monitoring.md) and [receiving deep-links](deep-linking.md). In addition to these, the following utilities are available.
## Opening URLs
