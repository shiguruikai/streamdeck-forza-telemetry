...
レースシミュレーションゲーム Forza Horizon および Forza Motorsport からテレメトリデータを受信し、Stream Deck + の液晶キーおよびタッチディスプレイの両方に対応した6つのアクション（速度計、レース情報、タイヤ温度、サスペンション移動量、Gフォース、コンパス）を提供する Stream Deck プラグイン。
